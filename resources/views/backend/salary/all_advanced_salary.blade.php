        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">All Advanced Salaries/ </h3>
                </div>
                <div class="card-body">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="padding-left:-30%;">
                                                <a href="{{ url('#' . $salary->id) }}"class="btn btn-sm btn-danger">View</a>
                                                <a href="{{ url('#' . $salary->id) }}"class="btn btn-sm btn-info">
                                                    Edit</a>
                                                <a href="{{ url('#' . $salary->id) }}" {{-- data-toggle="modal" data-target="#deleteModal" --}}
